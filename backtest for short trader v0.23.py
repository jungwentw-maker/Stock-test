...
def main():
    ...
    frame_sell_mode.grid(row=6, column=1, sticky="w", pady=(5, 0))

    frame_sell_input = tk.Frame(controls)
    frame_sell_input.grid(row=7, column=1, sticky="we", pady=(2, 0))
    ...
    entry_capital.grid(row=8, column=1, sticky="we", pady=(5, 0))
